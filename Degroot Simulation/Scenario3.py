...
for _ in range(10):
    ...
    G2 = Model2.ERNetwork(50, 4950, 0.01, 0.3, random_state)
    G3 = Model2.ERNetwork(50, 4950, 0.01, 0.5, random_state)
    G4 = Model2.ERNetwork(50, 4950, 0.01, 0.7, random_state)
    G5 = Model2.ERNetwork(50, 4950, 0.01, 0.9, random_state)
    # num_iteration = 0
    # opinion_history = []
...
for i in range(overall_iteration):
    ...
    doc_1_above.append(numpy.average(avg_opinions1[i])+10*numpy.var(avg_opinions1[i]))
    doc_1_below.append(numpy.average(avg_opinions1[i])-10*numpy.var(avg_opinions1[i]))
    doc_3.append(numpy.average(avg_opinions2[i]))
    doc_3_above.append(numpy.average(avg_opinions2[i])+10*numpy.var(avg_opinions2[i]))
    doc_3_below.append(numpy.average(avg_opinions2[i])-10*numpy.var(avg_opinions2[i]))
    doc_5.append(numpy.average(avg_opinions3[i]))
    doc_5_above.append(numpy.average(avg_opinions3[i])+10*numpy.var(avg_opinions3[i]))
    doc_5_below.append(numpy.average(avg_opinions3[i])-10*numpy.var(avg_opinions3[i]))
    doc_7.append(numpy.average(avg_opinions4[i]))
    doc_7_above.append(numpy.average(avg_opinions4[i])+10*numpy.var(avg_opinions4[i]))
    doc_7_below.append(numpy.average(avg_opinions4[i])-10*numpy.var(avg_opinions4[i]))
    doc_9.append(numpy.average(avg_opinions5[i]))
    doc_9_above.append(numpy.average(avg_opinions5[i])+10*numpy.var(avg_opinions5[i]))
    doc_9_below.append(numpy.average(avg_opinions5[i])-10*numpy.var(avg_opinions5[i]))
...
plt.fill_between(range(overall_iteration), doc_3_below, doc_3_above, color = "skyblue", alpha = 0.3)
plt.fill_between(range(overall_iteration), doc_5_below, doc_5_above, color = "lightsalmon", alpha = 0.3)
plt.fill_between(range(overall_iteration), doc_7_below, doc_7_above, color = "khaki", alpha = 0.3)
plt.fill_between(range(overall_iteration), doc_9_below, doc_9_above, color = "mediumspringgreen", alpha = 0.3)
plt.plot(range(overall_iteration), doc_1, alpha=1, color = "purple", label = "90 percent doctors with opinion 1")
plt.plot(range(overall_iteration), doc_3, alpha=1, color = "steelblue", label = "70 percent doctors with opinion 1")
plt.plot(range(overall_iteration), doc_5, alpha=1, color = "red", label = "50 percent doctors with opinion 1")
plt.plot(range(overall_iteration), doc_7, alpha=1, color = "gold", label = "30 percent doctors with opinion 1")
plt.plot(range(overall_iteration), doc_9, alpha=1, color = "green", label = "10 percent doctors with opinion 1")
...
plt.axhline(y = 1, xmin = 0, xmax = overall_iteration, linestyle = 'dashed', color = "black")
plt.axhline(y = 0, xmin = 0, xmax = overall_iteration, linestyle = 'dashed', color = "black")
plt.annotate(str('%.2f' % doc_1[overall_iteration-1]),xy=(overall_iteration,doc_1[overall_iteration-1]))
plt.annotate(str('%.2f' % doc_3[overall_iteration-1]),xy=(overall_iteration,doc_3[overall_iteration-1]))
plt.annotate(str('%.2f' % doc_5[overall_iteration-1]),xy=(overall_iteration,doc_5[overall_iteration-1]))
plt.annotate(str('%.2f' % doc_7[overall_iteration-1]),xy=(overall_iteration,doc_7[overall_iteration-1]))
plt.annotate(str('%.2f' % doc_9[overall_iteration-1]),xy=(overall_iteration,doc_9[overall_iteration-1]))
